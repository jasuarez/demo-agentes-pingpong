 ...
 *
 * Wrapper que se encarga de lanzar agentes Ping y Pong que no cargan el
 ...
 * @version $Revision$
 */
public class ClienteyServidor extends Agent {
	/**
	...
	protected void setup() {
		...
		for (int i=numAgents; i > 0; i--) {
			try {
				...
				container.createNewAgent("ping"+i, "pingpong.jade.ping.PingAgent", null).start();
			} catch (ControllerException e) {
