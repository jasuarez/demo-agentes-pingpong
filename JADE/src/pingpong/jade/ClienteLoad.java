 ...
 *
 * Wrapper que se encarga de lanzar agentes Ping que cargan el sistema.
 * 
 * $Id$
 */
 ...
 * @version $Revision$
 */
public class ClienteLoad extends Agent {
	/**
	...
	protected void setup() {
		...
		for (int i=numAgents; i > 0; i--) {
			try {
				...
				System.out.println ("CLIENTE> Ha ocurrido un problema al crear los pings");
				e.printStackTrace();
			}
		}
